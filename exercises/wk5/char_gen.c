...
/*
   ...
   TODO: Finish attribute generation DONE
...
void generate_crew_member(int crew_id) {
    ...
    chAgl[crew_id] = roll_dice(3, SIX_SIDED);
...
/*
    ...
    TODO: Finish implementing racial attribute adjustment DONE
...
/*
    ...
    TODO: Finish generating all skills DONE
...
void generate_skills(int crew_id) {
    ...
    chEng[crew_id] = gen_enc_skill(chIntel[crew_id], chAgl[crew_id], ROLL_NEW);
    chTac[crew_id] = gen_enc_skill(chStr[crew_id], chAgl[crew_id], ROLL_NEW);
